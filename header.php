...
//GEOCODER addition put your google api key YOURKEYHERE:)
    queue_js_file('geocoder');
    queue_js_url('//ubilabs.github.io/geocomplete/jquery.geocomplete.js');
    queue_js_url('http://maps.googleapis.com/maps/api/js?key=YOURKEYHERE&callback=initMap');
    queue_js_url('//polyfill.io/v3/polyfill.min.js?features=default');
//
